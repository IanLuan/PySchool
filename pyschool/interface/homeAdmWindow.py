...
"color: #fff;")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("interface/icons/work.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"color: #fff;")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("interface/icons/config.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
