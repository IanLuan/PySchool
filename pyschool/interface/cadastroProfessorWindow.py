...
# Form implementation generated from reading ui file 'cadastroProfessor.ui'
#
...
"")
        ...
        self.lineEmail_2 = QtWidgets.QLineEdit(self.frameComplementares)
        self.lineEmail_2.setGeometry(QtCore.QRect(220, 90, 501, 28))
        self.lineEmail_2.setStyleSheet("border: 1px solid grey;\n"
"border-radius: 5px;\n"
"font: 9pt \"Leelawadee UI Semilight\";\n"
"background-color: rgb(255, 255, 255);")
        self.lineEmail_2.setObjectName("lineEmail_2")
...
"")
    ...
    def retranslateUi(self, cadastroServidor):
        ...
        cadastroServidor.setWindowTitle(_translate("cadastroServidor", "Cadastrar Professor"))
        ...
        self.label_17.setText(_translate("cadastroServidor", "Matérias"))
        ...
        self.btnMaterias.setText(_translate("cadastroServidor", "Definir Matérias"))
